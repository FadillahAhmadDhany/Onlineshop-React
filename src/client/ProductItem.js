    ...
    addToCart = (item) => {
      ...
      render(){
        ...
        return (
            ...
            <div className="card h-100 shadow" style={{ marginBottom: "10px"}}>
                <a href="#"><img className="card-img-top" src={'http://localhost/eproduk/public/image/produk/' + item.img_brg} alt="" /></a>
